        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvestmentAmount = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Investments_CheckingAccounts_CheckingAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavingGoals_CheckingAccounts_CheckingAccountId",
                        column: x => x.CheckingAccountId,
                        principalTable: "CheckingAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_CheckingAccounts_DestinationAccountId",
                        column: x => x.DestinationAccountId,
                        principalTable: "CheckingAccounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_CheckingAccounts_SourceAccountId",
                        column: x => x.SourceAccountId,
                        principalTable: "CheckingAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_TransactionsHistory_TransactionHistoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Investments_CheckingAccountId",
                table: "Investments",
                column: "CheckingAccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SavingGoals_CheckingAccountId",
                table: "SavingGoals",
                column: "CheckingAccountId",
                unique: true);
