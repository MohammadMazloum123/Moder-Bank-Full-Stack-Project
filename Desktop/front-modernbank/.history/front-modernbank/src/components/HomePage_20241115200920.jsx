import { AccountBalanceWalletOutlined, CreditCardOutlined, SavingsOutlined, TrendingUpOutlined } from '@mui/icons-material';
import {Box, 
        Button,
        Grid2, 
        Typography,
        ...
        <Grid2 spacing={4} container>
            ...
            <Grid2 item xs={12} sm={6} md={3}>
                ...
                <CardContent>
                    ...
                    <LinearProgress variant="determinate" value={62.5} sx={{ height: 8, borderRadius: 4 }} />
                    <Typography variant="body2" color="text.secondary" mt={1}>
                    Monthly budget
                    </Typography>
                </CardContent>
