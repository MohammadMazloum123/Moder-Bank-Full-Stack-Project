            ...
            const addTransactionToAccount = (accountType: AccountType) => {
              ...
              try {
                if (transaction.type === 'transfer') {
                  ...
                  const accountBalance = getAccountBalance(transaction.fromAccount as AccountType);
                  if (accountBalance < transaction.amount) {
                    success = false;
                    message = 'Insufficient balance for withdrawal.';
                    return prevData;
                  }
                  pdateAccountBalance(transaction.fromAccount as AccountType, -transaction.amount);
                } else {
                  // Deposit
                    updateAccountBalance(transaction.toAccount as AccountType, transaction.amount);
                }
